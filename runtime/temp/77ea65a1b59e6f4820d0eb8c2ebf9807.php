...
<script type="text/javascript">
    ...
    <input type="hidden" name="row[model_id]" value="<?php echo \think\Request::instance()->param('model_id'); ?>" />
...
value2|title2</textarea>
    ...
    <div class="form-group hidden tf tf-select tf-selects tf-checkbox tf-radio tf-array">
        <label for="c-isfilter" class="control-label col-xs-12 col-sm-2"><?php echo __('Isfilter'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <div class="radio">
                <label for="row[isfilter]-yes"><input id="row[isfilter]-yes" name="row[isfilter]" type="radio" value="1" checked /> <?php echo __('Yes'); ?></label> 
                <label for="row[isfilter]-no"><input id="row[isfilter]-no" name="row[isfilter]" type="radio" value="0"  /> <?php echo __('No'); ?></label> 
            </div>
