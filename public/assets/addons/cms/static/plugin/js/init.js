...
$(function () {
    ...
    try {
        ...
        if (videoList && videoList.length > 0) {
            var playerPath = "common/plugin/ckplayer6.6/ckplayer/index.html";
        ...
        if (date && date.length > 0) {
            $.include('common/plugin/wap/datepicker/index.html', ['datepicker.js']);
            date.click(function () { WdatePicker({ whyGreen: 'twoer', dateFmt: 'yyyy-MM-dd HH:mm' }); });
        }
        //初始化表单验证组件
        var form = $("form[valid]");
        if (form && form.length > 0) {
            $.include('common/plugin/validform/index.html', ['css/style.css', 'js/validform.html', 'js/rule.js']);
        ...
        if (area && area.length > 0) {
            $.include('common/plugin/jquery.area/index.html', ['js/city.min.1.js', 'js/cityselect.js']);
            area.each(function () {
        ...
        if (imgLazy && imgLazy.length > 0) {
            $.include('common/plugin/jquery.lazyload/index.html', ['js/jquery.lazyload.js']);
        }
        //初始化评价星级插件
        var starBar = $(".starbar");
        if (starBar.length > 0) {
            $.getScript("common/plugin/jquery.raty/js/jquery.raty.html", function () {
                starBar.raty({
                    size: 35,
