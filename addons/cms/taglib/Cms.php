...
class Cms extends TagLib
{
    ...
    protected $tags = [
        ...
        'blocklist'   => ['attr' => 'id,row,limit,name,empty,key,mod,cache,orderby,orderway,imgwidth,imgheight,condition', 'close' => 1],
        'commentlist' => ['attr' => 'id,type,aid,pid,row,limit,fragment,empty,key,mod,cache,orderby,orderway,condition', 'close' => 1],
        'breadcrumb'  => ['attr' => 'id,empty,key,mod', 'close' => 1],
        'channellist' => ['attr' => 'id,model,row,limit,type,parent,empty,key,mod,cache,orderby,orderway,imgwidth,imgheight,condition', 'close' => 1],
        'arclist'     => ['attr' => 'id,model,row,limit,type,typeid,flag,channel,tags,empty,key,mod,cache,orderby,orderway,addon,imgwidth,imgheight,condition', 'close' => 1],
        'tagslist'    => ['attr' => 'id,row,limit,type,empty,key,mod,cache,orderby,orderway,condition', 'close' => 1],
