<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:88:"C:\phpStudy\PHPTutorial\WWW\he\public/../application/admin\view\cms\archives\fields.html";i:1527831871;}*/ ?>
...
<div class="form-group">
    ...
    <div class="col-xs-12 col-sm-8">
        ...
        <textarea id="content_<?php echo $item['name']; ?>" name="row[<?php echo $item['name']; ?>]" class="form-control <?php if($item['type'] == 'editor'): ?>editor<?php endif; ?>" data-rule="<?php echo $item['rule']; ?>" rows="5" data-tip="<?php echo $item['tip']; ?>" <?php echo $item['extend']; ?>><?php echo $item['value']; ?></textarea>
        ...
        <?php break; case "date": ?>
        <input type="text" name="row[<?php echo $item['name']; ?>]" value="<?php echo $item['value']; ?>" class="form-control datetimepicker" data-date-format="YYYY-MM-DD" data-tip="<?php echo $item['tip']; ?>" data-rule="<?php echo $item['rule']; ?>" <?php echo $item['extend']; ?> />
        <?php break; case "time": ?>
        <input type="text" name="row[<?php echo $item['name']; ?>]" value="<?php echo $item['value']; ?>" class="form-control datetimepicker" data-date-format="HH:mm:ss" data-tip="<?php echo $item['tip']; ?>" data-rule="<?php echo $item['rule']; ?>" <?php echo $item['extend']; ?> />
        <?php break; case "datetime": ?>
        <input type="text" name="row[<?php echo $item['name']; ?>]" value="<?php echo $item['value']; ?>" class="form-control datetimepicker" data-date-format="YYYY-MM-DD HH:mm:ss" data-tip="<?php echo $item['tip']; ?>" data-rule="<?php echo $item['rule']; ?>" <?php echo $item['extend']; ?> />
