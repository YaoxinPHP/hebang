<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:85:"C:\phpStudy\PHPTutorial\WWW\he\public/../application/admin\view\cms\channel\edit.html";i:1527822213;s:73:"C:\phpStudy\PHPTutorial\WWW\he\application\admin\view\layout\default.html";i:1526467896;s:70:"C:\phpStudy\PHPTutorial\WWW\he\application\admin\view\common\meta.html";i:1526467896;s:72:"C:\phpStudy\PHPTutorial\WWW\he\application\admin\view\common\script.html";i:1526467896;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        <label for="c-parent_id" class="control-label col-xs-12 col-sm-2"><?php echo __('上级栏目'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <select name="row[parent_id]" data-rule="required" id="parent_id" class="form-control selectpicker">
                ...
                <option value="<?php echo $vo['id']; ?>" <?php if($vo['type']=='link' || $vo['id']==$row['id']): ?>disabled<?php endif; if($vo['id']==$row['parent_id']): ?>selected<?php endif; ?>><?php echo $vo['name']; ?></option>
                <?php endforeach; endif; else: echo "" ;endif; ?>
            </select>
        </div>
    </div>
    ...
    <div class="form-group tf tf-channel">
        ...
        <div class="col-xs-12 col-sm-4">
            <input id="c-channeltpl" data-rule="required" class="form-control" name="row[channeltpl]" type="text" value="<?php echo $row['channeltpl']; ?>">
        </div>
    </div>
    <div class="form-group tf tf-list">
        <label for="c-listtpl" class="control-label col-xs-12 col-sm-2"><?php echo __('Listtpl'); ?>:</label>
        <div class="col-xs-12 col-sm-4">
            <input id="c-listtpl" data-rule="required" class="form-control" name="row[listtpl]" type="text" value="<?php echo $row['listtpl']; ?>">
        </div>
    </div>
    <div class="form-group tf tf-list">
        <label for="c-showtpl" class="control-label col-xs-12 col-sm-2"><?php echo __('Showtpl'); ?>:</label>
        <div class="col-xs-12 col-sm-4">
            <input id="c-showtpl" data-rule="required" class="form-control" name="row[showtpl]" type="text" value="<?php echo $row['showtpl']; ?>">
        </div>
    </div>
    <div class="form-group tf tf-list">
