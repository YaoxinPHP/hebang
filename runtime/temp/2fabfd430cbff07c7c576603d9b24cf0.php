...
<script type="text/javascript">
    ...
    <div class="form-group hidden tf tf-select tf-selects tf-checkbox tf-radio tf-array">
        ...
        <div class="col-xs-12 col-sm-8">
            <div class="radio">
                <label for="row[isfilter]-yes"><input id="row[isfilter]-yes" name="row[isfilter]" type="radio" value="1" <?php if($row['isfilter']==1): ?>checked<?php endif; ?> /> <?php echo __('Yes'); ?></label> 
                <label for="row[isfilter]-no"><input id="row[isfilter]-no" name="row[isfilter]" type="radio" value="0"  <?php if($row['isfilter']==0): ?>checked<?php endif; ?>/> <?php echo __('No'); ?></label> 
            </div>
