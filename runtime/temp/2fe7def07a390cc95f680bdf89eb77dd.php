                    ...
                    <div id="myTabContent" class="tab-content">
                        <div class="tab-pane fade active in" id="basic">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-12 col-sm-8">
                                    <input id="c-tags" data-rule="required" class="form-control selectpage" placeholder="请手动输入或选择标签" data-source="cms/tags/selectpage" data-primary-key="name" data-multiple="true" name="row[tags]" type="text" value="<?php echo $row['tags']; ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-12 col-sm-8">
                                    <div class="input-group">
                                        ...
                                        <input type="text" data-rule="diyname" name="row[diyname]" class="form-control" placeholder="请输入自定义的名称" value="<?php echo $row['diyname']; ?>" />
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-12 col-sm-8">
                                    <textarea id="c-description" class="form-control editor" name="row[description]" rows="15" ><?php echo $row['description']; ?></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
