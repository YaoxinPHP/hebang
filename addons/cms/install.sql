...
BEGIN;
INSERT INTO `__PREFIX__block` VALUES (1, 'focus', 'focus', '幻灯图片1', '/assets/addons/cms/img/focus/1.jpg', 'https://www.fastadmin.net', '111', 0, 0, 'normal');
INSERT INTO `__PREFIX__block` VALUES (2, 'focus', 'focus', '幻灯图片2', '/assets/addons/cms/img/focus/2.jpg', 'https://www.fastadmin.net', '222', 0, 0, 'normal');
INSERT INTO `__PREFIX__block` VALUES (3, 'focus', 'focus', '幻灯图片3', '/assets/addons/cms/img/focus/3.jpg', 'https://www.fastadmin.net', '333', 0, 0, 'normal');
...
INSERT INTO `__PREFIX__block` VALUES (7, 'other', 'bannerad', '通栏广告', '/assets/addons/cms/img/banner/1.jpg', 'https://www.fastadmin.net', '', 0, 0, 'normal');
INSERT INTO `__PREFIX__block` VALUES (8, 'other', 'sidebarad1', '边栏广告1', '/assets/addons/cms/img/sidebar/1.jpg', 'https://www.fastadmin.net', '', 0, 0, 'normal');
INSERT INTO `__PREFIX__block` VALUES (9, 'other', 'sidebarad2', '边栏广告2', '/assets/addons/cms/img/sidebar/2.jpg', 'https://www.fastadmin.net', '', 0, 0, 'normal');
COMMIT;
...
INSERT INTO `__PREFIX__channel` VALUES (41, 'link', 7, 0, '官网首页', '', '', '', 'official', 'https://www.fastadmin.net', 0, 6, 'channel.html', '', '', 10, 1508994753, 1508994753, 'normal');
INSERT INTO `__PREFIX__channel` VALUES (42, 'link', 7, 0, '交流社区', '', '', '', 'forum', 'https://forum.fastadmin.net', 0, 3, 'channel.html', '', '', 10, 1508994772, 1508994772, 'normal');
INSERT INTO `__PREFIX__channel` VALUES (43, 'link', 7, 0, '文档', '', '', '', 'docs', 'https://doc.fastadmin.net', 0, 2, 'channel.html', '', '', 10, 1508994788, 1508994788, 'normal');
COMMIT;
...
CREATE TABLE `__PREFIX__model` (
  ...
  `table` char(50) NOT NULL DEFAULT '' COMMENT '表名',
...
CREATE TABLE `__PREFIX__comment` (
  ...
  `useragent` varchar(500) NOT NULL DEFAULT '' COMMENT 'User Agent',
